...
public class Driver {
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException, InterruptedException {
		...
		conf1.set("textinputformat.record.delimter", ".");
		...
		DBConfiguration.configureDB(conf2, 
				...
				"jdbc:mysql://192.168.0.113:8889/test",
				"root",
				"root");
		...
		//2.use this method to define the dependency path on hdfs
		job2.addArchiveToClassPath(new Path("/mysql/mysql-connector-java-5.1.39-bin.jar"));

		//Mapper's output key and value are inconsistent with reducer output key and value
